    ...
    public TicksPanel(JSONArray tableData) {
        ...
        try {
            ...
            for (int i = 0; i < tableData.length(); i++) {
                ...
                String bid = js.getDouble("bid") + "";
                String last = js.getDouble("ltp") + "";
                String ask = js.getDouble("ask") + "";
                String date = js.getString("createdAt");
                String volume = js.getDouble("volume") + "";
            ...
            System.out.println("exception occurred in ticks panel of orderdealspopup frame");
